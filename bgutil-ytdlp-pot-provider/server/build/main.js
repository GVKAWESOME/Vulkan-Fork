...
httpServer.post("/get_pot", async (request, response) => {
    ...
    try {
        const sessionData = await sessionManager.generatePoToken(contentBinding, proxy, bypassCache, sourceAddress, disableTlsVerification, body.challenge, body.disable_innertube || false, body.innertube_context);
